class SchoolsController < ApplicationController
  def new
    school = School.create! name: params[:name], email: params[:email],
                            phone: params[:phone], abbreviation: params[:abbreviation],
                            state: params[:state], city: params[:city],
                            neighbourhood: params[:neighbourhood], address: params[:address],
                            number: params[:number], profile_nursery: params[:profile_nursery],
                            ...
                            profile_art: params[:profile_art], profile_kid: params[:profile_kid],
                            profile_teenager: params[:profile_teenager],
                            profile_adult: params[:profile_adult], profile_elderly: params[:profile_elderly],
                            ...
                            profile_employee: params[:profile_employee], profile_family: params[:profile_family],
                            profile_baby: params[:profile_baby], contact_name: params[:contact_name],
                            contact_email: params[:contact_email],
                            contact_phone: params[:contact_phone], contact_position: params[:contact_position],
                            ...
                            need_sport: params[:need_sport], need_culture: params[:need_culture],
                            need_monitoring: params[:need_monitoring], need_courses: params[:need_courses],
                            need_repairs: params[:need_repairs], need_health: params[:need_health],
